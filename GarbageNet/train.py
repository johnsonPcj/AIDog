...
import keras
from keras.optimizers import adam_v2 #modified by liujun,2022.01.22
...
opt = keras.optimizers.adam_v2.Adam(learning_rate=INIT_LR,decay=INIT_LR / EPOCHS,beta_1=0.9, beta_2=0.999, epsilon=1e-08)
